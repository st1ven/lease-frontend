<template>
	<view>
		<view class="youhuiquantop"
			style="padding: 10px;text-align: center;background: #fff;border-radius: 10px 10px 0pt 0pt;">
		...
		<view class="" style="padding: 5px 20px;">
			...
			<view class="topzuqi">
				...
				<view class="topkuang">
					...
					<view class="big bigright">
						...
						<text class="textshu" style="color: #ff4700;font-weight: 800;"
							v-if="goodinfo.month_rent != '0.00'">￥{{ goodinfo.month_rent }}/月</text>
						<u-line color="#EAE9E5"></u-line>
						<text class="textshu">￥{{ goods_data ? goods_data.each_price || '--' : '--' }}/月</text>
					</view>
				</view>
			</view>
			<view class="topzuqi">
			...
			<view class="topzuqi">
				...
				<view class="topkuang" style="font-size: 13px;color: #858585;">
					如您未能按期、足额支付本协议约定的款项（包括但不限于租金、服务费、买断价、赔偿金），自逾期之日起，您应按照10元/天向机转转支付滞纳金。本协议项下，滞纳金收取上限不超过租赁总费用与到期买断价之和的12%。
				</view>
			</view>
		</view>
	</view>
