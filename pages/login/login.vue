		...
		<view class="login-form">
			<view class="login-form-item">
				...
				<view class="login-form-item-input">
					<u-input class="input" v-model="model.mobile" style="font-size: 38rpx;"
						placeholder-style="font-size: 38rpx;" type="number" placeholder="请输入手机号" />
				</view>
			</view>
			<view class="login-form-item">
				<view class="login-form-item-icon">
				...
				<view class="login-form-item-input">
					<u-input class="input" v-model="model.code" style="font-size: 38rpx;"
						placeholder-style="font-size: 38rpx;" type="number" placeholder="请输入验证码" />
				</view>
          ...
          <u-input class="input" v-model="model.userid" style="font-size: 38rpx;" placeholder-style="font-size: 38rpx;"
			...
			<view class="login-form-tips">
				...
				<view>
					...
					<text class="login-form-tips-likeA"
						@click="agreement({ title: '隐私协议', _url: 'privacy' })">《隐私协议》</text>
				</view>
